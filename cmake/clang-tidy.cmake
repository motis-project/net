...
if(CLANG_TIDY_NAMESPACES)
  ...
  set(CMAKE_CXX_CLANG_TIDY "${CLANG_TIDY_COMMAND};-config={Checks: '-*,modernize-concat-nested-namespaces',WarningsAsErrors: '*',HeaderFilterRegex: ^(base/)|(modules/)|(test/)};-fix;-format-style=file")
else()
