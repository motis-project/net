...
if(CLANG_TIDY_NAMESPACES)
  ...
  set(CMAKE_CXX_CLANG_TIDY "${CLANG_TIDY_COMMAND};-config={Checks: '-*,modernize-concat-nested-namespaces',WarningsAsErrors: '*',HeaderFilterRegex: ^(include/)};-fix;-format-style=file")
else()
  find_program(CLANG_TIDY_COMMAND NAMES clang-tidy-9 clang-tidy)
  if(NOT CLANG_TIDY_COMMAND)
